...
def gen_mesh(G, ws=None, triplane=None, save_path='temp_mesh.mrc', device='cuda', shape_format='ply'):
    ...
    convert_sdf_samples_to_ply(np.transpose(sigmas, (2, 1, 0)), [0, 0, 0], 1, os.path.join(save_path, f'face.ply'), scale=1000, level=10)
